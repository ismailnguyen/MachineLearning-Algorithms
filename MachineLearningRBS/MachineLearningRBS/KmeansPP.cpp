...
/*vector<vector<int> > RunKMeansPP(int K, vector<datapoint> &centroids)
{
...
void updateNearestClusters(const vector<datapoint> &centroids_)
{
	for (int i = 0; i < input_data.size(); ++i)
	{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////
void updateCentroids(const vector<datapoint> &centroids_)
{
...
bool equalCentroids(const vector<datapoint> &centroid_vec_a, const vector<datapoint> &centroid_vec_b)
{
	double total_dist = 0;
